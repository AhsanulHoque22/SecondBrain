...
% ---------- Palette: grayscale only. Color is reserved for Figure 1. ----------
\definecolor{ink}{HTML}{1A1A1A}
\definecolor{graytext}{HTML}{444444}
\definecolor{grayrule}{HTML}{BFBFBF}
\definecolor{graylight}{HTML}{EDEDED}
\definecolor{graymed}{HTML}{8C8C8C}
\definecolor{graydark}{HTML}{262626}

\definecolor{phaseA}{HTML}{2E75B6} % Figure 1 only - ingestion - steel blue
\definecolor{phaseB}{HTML}{128A7D} % Figure 1 only - processing - teal
\definecolor{phaseC}{HTML}{C8790D} % Figure 1 only - storage - amber
\definecolor{phaseD}{HTML}{6C3483} % Figure 1 only - serving - purple

% ---------- Headings ----------
\titleformat{\section}
  {\Large\bfseries\color{ink}}{\thesection}{0.6em}{}[{\color{grayrule}\titlerule[1pt]}]
...
\lhead{\small\color{graytext}AspiroBrain Data Pipeline --- Implementation Plan}
\rhead{\small\color{graytext}AspiroEdu Internal}
\cfoot{\small\color{graytext}\thepage\ of \pageref{LastPage}}
\usepackage{lastpage}

% ---------- Callout boxes: gray highlight only, no color ----------
\newtcolorbox{infobox}[1][]{
  breakable, enhanced, colback=graylight, colframe=grayrule,
  boxrule=0.6pt, left=8pt, right=8pt, top=6pt, bottom=6pt,
  arc=2pt, title={#1}, fonttitle=\bfseries\small, coltitle=white,
  colbacktitle=graydark
}
...
\begin{tikzpicture}[remember picture, overlay]
  \fill[graydark] (current page.north west) rectangle ([yshift=-7.2cm]current page.north east);
  \fill[graymed] (current page.north west) rectangle ([yshift=-0.18cm]current page.north east);
...
\vfill
\begin{center}
\small\color{graytext} Confidential --- Internal AspiroEdu Working Document
\end{center}
\vspace{1cm}
\restoregeometry
\end{titlepage}
...
\draw[arr, graymed] (A2.south) to[out=-90,in=90] (B1.north);
...
\draw[arr, graymed] (B4.south) to[out=-90,in=90] (C1.north);
...
\draw[arr, graymed] (C1.south) to[out=-90,in=90] (D1.north);
...
\begin{itemize}[leftmargin=1.4em, itemsep=3pt]
  \small
  \item \href{https://frankfurter.dev}{Frankfurter API}
  \item \href{https://github.com/fawazahmed0/exchange-api}{fawazahmed0/exchange-api (GitHub)}
  \item \href{https://engineering.freeagent.com/2025/05/29/decoding-data-orchestration-tools-comparing-prefect-dagster-airflow-and-mage/}{Decoding Data Orchestration Tools: Prefect, Dagster, Airflow, Mage}
  \item \href{https://www.prefect.io/compare/dagster}{Prefect vs Dagster}
  \item \href{https://medium.com/@amarshaw83/rapidfuzz-339295aece71}{RapidFuzz --- A Fast, Flexible, Modern Library}
  \item \href{https://aeturrell.com/blog/posts/the-data-validation-landscape-in-2025/}{The Data Validation Landscape in 2025}
  \item \href{https://medium.com/@bhagyarana80/8-great-expectations-vs-pandera-which-fits-your-python-stack-a115c9241dcb}{Great Expectations vs Pandera}
  \item \href{https://abhishekchaudhary.com/blog/sqlite-vs-postgres-solo-founder}{SQLite vs Postgres for the Solo Founder in 2026}
  \item \href{https://solodevstack.com/blog/sqlite-vs-supabase-solo-developers}{SQLite vs Supabase for Solo Developers}
  \item \href{https://dataladder.com/fuzzy-matching-101/}{Fuzzy Matching 101: The Complete Guide to Accurate Data Matching}
\end{itemize}

\vspace{0.6cm}
{\small\color{graytext}\textit{Prepared as part of the AspiroWork data internship, grounded in the live mastersportal.com scraping pipeline (Netherlands + Malta, 200 programs, 10 July 2026).}}
