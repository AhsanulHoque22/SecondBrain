# Recall Schedule — 2026-06-07

## Due Today (15 topics)
- 🔁 **Intelligent Agents + Environments (PAGE)** `CSE713_AI` ⚠️ 4d overdue | conf 4/5
- 🔁 **Search: UCS, Greedy, A, IDDFS — trace on graph** `CSE713_AI` ⚠️ 4d overdue | conf 4/5
- 🔁 **Forward + Backward Chaining + Rule-Based System** `CSE713_AI` ⚠️ 1d overdue | conf 5/5
- 🔁 **↳ PL Basics: satisfiability, validity, entailment, Modus Ponens** `CSE713_AI` ⚠️ 1d overdue | conf 5/5
- 🔁 **↳ Resolution in PL: clause form (4-step), refutation proof** `CSE713_AI` ⚠️ 1d overdue | conf 5/5
